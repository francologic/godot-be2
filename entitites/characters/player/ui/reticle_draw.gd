...
@export var left_reticle_starting_point : Vector2 = Vector2(-30,0) : set = set_left_reticle_starting_point
@export var left_reticle_finishing_point : Vector2 = Vector2(-15,0) : set = set_left_reticle_finishing_point

@export_category("Right Line")
@export var right_reticle_starting_point : Vector2 = Vector2(30,0) : set = set_right_reticle_starting_point
@export var right_reticle_finishing_point : Vector2 = Vector2(15,0) : set = set_right_reticle_finishing_point
...
func draw_side_reticle():
	draw_line(left_reticle_starting_point, left_reticle_finishing_point, reticle_color, reticle_width, true)
	draw_line(right_reticle_starting_point, right_reticle_finishing_point, reticle_color, reticle_width, true)
